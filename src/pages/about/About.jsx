      ...
      <div className="flex flex-col md:flex-row items-center md:justify-center">
        ...
        <div className="w-5/6 md:w-1/2 mx-5 my-10">
          ...
          <p className="my-3 font-light text-lg text-center">
            ...
            ipsum consequuntur magni voluptatem commodi minima mollitia,
            veritatis perferendis minus hic rem itaque consectetur ab tempore
            explicabo?
          </p>
          <p className="my-3 font-light text-lg text-center">
          ...
          <p className="my-3 text-center font-light text-lg">
            ...
            laboriosam, eum perferendis velit natus autem earum consequatur,
            quasi eligendi doloremque suscipit.
          </p>
        </div>
      </div>
