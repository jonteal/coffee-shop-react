...
const HomeInfoPictureGrid = () => {
  return (
    <div className="wrapper mb-5">
      ...
      <div className="grid-item flex flex-col items-center justify-center bg-yellow-600">
      ...
      <div className="grid-item flex flex-col items-center justify-center bg-cyan-600">
